 ...
 * 
 * The consumer sends a POST request to the url http[s]://your-shop.eg/api.php/v2/emails.
 */
$resultArray = $consumer->post(HTTP_SERVER . DIR_WS_CATALOG . 'api.php/v2/emails',
