<?php
/* --------------------------------------------------------------
   create_category.php 2016-02-16
   Gambio GmbH
   http://www.gambio.de
 ...
 */
$requestJson = file_get_contents('./json-samples/PostCategoryRequest.json');
 ...
 * 
 * The consumer sends a POST request to the url http[s]://your-shop.eg/api.php/v2/categories.
 */
$resultArray = $consumer->post(HTTP_SERVER . DIR_WS_CATALOG . 'api.php/v2/categories',
                               array('Content-Type: application/json'),
                               $requestJson)->getBodyAsArray();

echo displayCategoryData($resultArray);
