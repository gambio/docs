 ...
 * 
 * The consumer sends a DELETE request to the url http[s]://your-shop.eg/api.php/v2/orders/[orderId].
 */
$resultArray = $consumer->delete(HTTP_SERVER . DIR_WS_CATALOG . 'api.php/v2/orders/' . $orderId)->getBodyAsArray();

?>

<html>
	<head>
		<title>REST ORDER Delete Sample</title>
		<link rel="stylesheet"
	...
	<body class="container-fluid">
		...
		<?php else: ?>
			<div class="alert alert-success text-center">
				Deleted order with ID <?php echo $orderId; ?>
			</div>
