 ...
 */
$requestJson = file_get_contents('./json-samples/PutProductRequest.json');
 ...
 * 
 * The consumer sends a PUT request to the url http[s]://your-shop.eg/api.php/v2/products/[productId].
 */
$resultArray = $consumer->put(HTTP_SERVER . DIR_WS_CATALOG . 'api.php/v2/products/' . $productId,
                              array('Content-Type: application/json'),
                              $requestJson)->getBodyAsArray();

echo displayProductData($resultArray, 'updated');
