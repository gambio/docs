...
$themeSettingsArray = [
    ...
    'MENUBOXES'                  => [
        ...
        'admin'                   => ['POSITION' => 'gm_box_pos_3', 'STATUS' => 1],
        'bestsellers'             => ['POSITION' => 'gm_box_pos_4', 'STATUS' => 1],
        'categories'              => ['POSITION' => 'gm_box_pos_1', 'STATUS' => 1],
        'content'                 => ['POSITION' => 'gm_box_pos_5', 'STATUS' => 1],
        ...
        'gm_trusted_shops_widget' => ['POSITION' => 'gm_box_pos_7', 'STATUS' => 1],
        ...
        'mailbeez_shopvoting'     => ['POSITION' => 'gm_box_pos_22', 'STATUS' => 1],
        'manufacturers'           => ['POSITION' => 'gm_box_pos_10', 'STATUS' => 1],
        'manufacturers_info'      => ['POSITION' => 'gm_box_pos_11', 'STATUS' => 1],
        'newsletter'              => ['POSITION' => 'gm_box_pos_8', 'STATUS' => 1],
        'order_history'           => ['POSITION' => 'gm_box_pos_6', 'STATUS' => 1],
        'paypal'                  => ['POSITION' => 'gm_box_pos_20', 'STATUS' => 0],
        'search'                  => ['POSITION' => 'gm_box_pos_12', 'STATUS' => 0],
        'specials'                => ['POSITION' => 'gm_box_pos_9', 'STATUS' => 1],
