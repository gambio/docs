 ...
 * 
 * The consumer sends a GET request to the url http[s]://your-shop.eg/api.php/v2/products/[productId].
 */
$resultArray = $consumer->get(HTTP_SERVER . DIR_WS_CATALOG . 'api.php/v2/products/' . $productId)->getBodyAsArray();

echo displayProductData($resultArray, false);
