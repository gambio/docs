<?php
/* --------------------------------------------------------------
   remove_category.php 2016-02-16
   Gambio GmbH
   http://www.gambio.de
 ...
 * 
 * The consumer sends a DELETE request to the url http[s]://your-shop.eg/api.php/v2/categories/[categoryId].
 */
$resultArray =
	$consumer->delete(HTTP_SERVER . DIR_WS_CATALOG . 'api.php/v2/categories/' . $categoryId)->getBodyAsArray();
?>

<html>
	<head>
		<title>REST Category Delete Sample</title>
		<link rel="stylesheet"
	...
	<body class="container-fluid">
		...
		<?php else: ?>
			<div class="alert alert-success text-center">
				Bestellung mit der ID <?php echo $orderId ?> gelöscht.
			</div>
			<pre>
				Response:
