<?php
/* --------------------------------------------------------------
   update_category.php 2016-02-24
   Gambio GmbH
   http://www.gambio.de
 ...
 */
$requestJson = file_get_contents('./json-samples/PutCategoryRequest.json');
 ...
 * 
 * The consumer sends a PUT request to the url http[s]://your-shop.eg/api.php/v2/categories.
 */
$resultArray = $consumer->put(HTTP_SERVER . DIR_WS_CATALOG . 'api.php/v2/categories/' . $categoryId,
                              array('Content-Type: application/json'),
                              $requestJson)->getBodyAsArray();

echo displayCategoryData($resultArray, 'updated');
