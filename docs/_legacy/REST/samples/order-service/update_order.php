 ...
 */
$requestJson = file_get_contents('./json-samples/PutOrderRequest.json');

$orderId = 400210; // 400210 is the first created order id
 ...
 * 
 * The consumer sends a PUT request to the url http[s]://your-shop.eg/api.php/v2/orders/[orderId].
 */
$resultArray = $consumer->put(HTTP_SERVER . DIR_WS_CATALOG . 'api.php/v2/orders/' . $orderId,
