 ...
 */
$requestJson = file_get_contents('./json-samples/PostRegistreeRequest.json');
 ...
 */
$requestJson = str_replace('"email": "customer3@example.org"',
                           '"email": "rest-api-example-customer-' . mt_rand(100, 999) . '@example.de"',
                           $requestJson);
 ...
 */
$resultArray = $consumer->post(HTTP_SERVER . DIR_WS_CATALOG . 'api.php/v2/customers',
