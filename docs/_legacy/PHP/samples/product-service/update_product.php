...
foreach($languageCodeArray as $languageCode):
	$product->setName(new StringType('Updated Article Name'), $languageCode);
	...
	$product->setUrl(new StringType('https://www.google.de'), $languageCode);
